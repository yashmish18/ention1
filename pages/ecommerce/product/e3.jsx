     ...
     <section className="max-w-6xl mx-auto mt-12 px-4">
       ...
       <div className="block md:hidden rounded-2xl bg-white/10 backdrop-blur-sm border border-white p-4 shadow-xl">
         <div className="grid grid-cols-2 gap-0 border border-white/30 rounded overflow-hidden">
           {/* Each pair: label/value (replace with E3 specs) */}
           <div className="font-bold text-white bg-[#0FAFCA]/10 p-2 border-b border-r border-white/30">Colour</div>
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">Gray</div>
           ...
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">Intel i7-12th Gen</div>
           ...
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">12 Core, 16 Threads, 18MB Cache</div>
           <div className="font-bold text-white bg-[#0FAFCA]/10 p-2 border-b border-r border-white/30">Memory card reader</div>
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">Yes, SD card</div>
           <div className="font-bold text-white bg-[#0FAFCA]/10 p-2 border-b border-r border-white/30">Graphic</div>
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">Intel Iris Xe</div>
           <div className="font-bold text-white bg-[#0FAFCA]/10 p-2 border-b border-r border-white/30">Earphone port</div>
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">3.5mm jack</div>
           ...
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">Windows 11</div>
           <div className="font-bold text-white bg-[#0FAFCA]/10 p-2 border-b border-r border-white/30">Speaker</div>
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">Built-in stereo speaker</div>
           ...
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">2.0MP, with Privacy shutter</div>
           <div className="font-bold text-white bg-[#0FAFCA]/10 p-2 border-b border-r border-white/30">USB</div>
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">3x USB 3.0, Type C</div>
           ...
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">Backlit, Numeric Keypad</div>
           <div className="font-bold text-white bg-[#0FAFCA]/10 p-2 border-b border-r border-white/30">Product Dimension and weight</div>
           <div className="text-white bg-[#0FAFCA]/5 p-2 border-b border-white/30">360mm*240mm*15mm, 1.8KG</div>
     ...
     <section className="max-w-7xl mx-auto mt-24 mb-24 px-4">
       <div className="flex justify-center items-center w-full">
         <div className="w-full max-w-lg md:max-w-7xl aspect-video rounded-xl overflow-hidden bg-black">
           <video
             src="/assets/product_/e3/e3_video.mp4"
             controls
